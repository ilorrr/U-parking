...
QLABS_LIB_PATH = r"C:\Users\user\Documents\Quanser\0_libraries\python"
...
QCAR_TARGET_HOVER = 3.0

# QCAR LIVE POSITION POLLER
...
def fly_to(drone, x, y, z, speed=3.0, hover_pause=1.0):
    ...
    """
    global _drone_pos
    STEP_SIZE = 0.8     # smaller steps = smoother motion
    STEP_DT   = 0.35   # faster updates = less stutter
...
class DroneScanner:
    ...
    def run(self, qlabs, vehicle_actors, qcar_actors=None,
        ...
        # Stop the real-time model for kinematic flight control
        ...
        #Initialize drone position tracker from ACTUAL spawn location
        ...
        # Vision data collection summary
        if self._collector:
